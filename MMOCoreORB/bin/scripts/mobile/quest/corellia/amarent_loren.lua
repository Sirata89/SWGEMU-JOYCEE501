amarent_loren = Creature:new {
	objectName = "@mob/creature_names:commoner",
	customName = "Amarent Loren",
	...
	conversationTemplate = "amarent_loren_convo_template",
...
CreatureTemplates:addCreatureTemplate(amarent_loren, "amarent_loren")
