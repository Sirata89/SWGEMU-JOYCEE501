...
includeFile("custom/jedi/light_jedi_padawan.lua")
includeFile("custom/jedi/dark_jedi_padawan.lua")
includeFile("custom/jedi/jedi_shop_keeper.lua")
includeFile("custom/jedi/jedi_quest_giver.lua")
...
includeFile("custom/mobs/meatlump_spike.lua")
includeFile("custom/mobs/meatlump_killer.lua")
includeFile("custom/mobs/meatlump_luci.lua")
includeFile("custom/mobs/meatlump_lillith.lua")
includeFile("custom/mobs/meatlump_king_atst.lua")
