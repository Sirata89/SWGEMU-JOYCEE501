...
function LizardCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("dantooine", "voritor_lizard", 300, 22.760, -42.017, -65.515, 8.926, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 25.077, -42.523, -66.183, 1.738, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 26.571, -42.597, -64.250, 56.130, 8535539)
	spawnMobile("dantooine", "voritor_dasher", 300, 27.312, -41.837, -60.359, 19.055, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 28.018, -43.482, -68.823, 19.908, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 43.912, -47.290, -29.021, -177.829, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 44.212, -46.239, -27.302, -120.821, 8535539)
	spawnMobile("dantooine", "voritor_dasher", 300, 44.014, -47.441, -26.657, -163.767, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 43.192, -46.779, -5.331, 178.254, 8535539)
	spawnMobile("dantooine", "voritor_dasher", 300, 42.570, -47.166, -9.481, 160.761, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 41.264, -46.909, -12.460, 169.094, 8535539)
	...
	spawnMobile("dantooine", "voritor_lizard", 300, 51.554, -67.905, -45.620, 101.773, 8535539)
	spawnMobile("dantooine", "horned_voritor_lizard", 300, 50.955, -67.979, -43.690, 9.053, 8535539)
	spawnMobile("dantooine", "voritor_lizard", 300, 55.401, -68.511, -38.735, 84.611, 8535539)
	spawnMobile("dantooine", "voritor_dasher", 300, 57.296, -68.663, -41.529, 78.881, 8535539)
	...
	spawnMobile("dantooine", "horned_voritor_lizard", 300, 92.984, -62.319, -17.336, 70.119, 8535540)
	spawnMobile("dantooine", "voritor_lizard", 300, 91.502, -61.936, -14.126, -100.567, 8535540)
	spawnMobile("dantooine", "voritor_lizard", 300, 92.977, -61.683, -12.733, -99.244, 8535540)
	spawnMobile("dantooine", "voritor_lizard", 300, 85.013, -63.262, -20.888, -116.243, 8535540)
	spawnMobile("dantooine", "voritor_lizard", 300, 87.838, -62.839, -21.151, 64.944, 8535540)
	spawnMobile("dantooine", "voritor_dasher", 300, 83.839, -68.181, -39.295, 4.116, 8535540)
	spawnMobile("dantooine", "horned_voritor_lizard", 300, 85.836, -68.086, -39.546, 78.668, 8535540)
	...
	spawnMobile("dantooine", "voritor_dasher", 300, 95.256, -75.689, -69.152, 66.542, 8535541)
	spawnMobile("dantooine", "grassland_voritor_tracker", 300, 95.246, -75.689, -69.144, 56.139, 8535541)
	spawnMobile("dantooine", "voritor_lizard", 300, 91.626, -76.248, -70.429, 6.038, 8535541)
	spawnMobile("dantooine", "voritor_dasher", 300, 92.067, -76.134, -72.352, 140.193, 8535541)
	spawnMobile("dantooine", "voritor_lizard", 300, 61.868, -76.312, -79.295, 7.240, 8535541)
	spawnMobile("dantooine", "voritor_dasher", 300, 63.514, -76.569, -77.483, 23.437, 8535541)
	spawnMobile("dantooine", "voritor_lizard", 300, 62.265, -76.407, -77.103, 2.890, 8535541)
	spawnMobile("dantooine", "grassland_voritor_tracker", 300, 65.369, -76.885, -77.933, 102.814, 8535541)
	...
	spawnMobile("dantooine", "voritor_lizard", 300, 130.259, -66.362, -113.777, 45.641, 8535545)
	spawnMobile("dantooine", "voritor_lizard", 300, 129.998, -66.563, -110.709, 45.811, 8535545)
	spawnMobile("dantooine", "slinking_voritor_hunter", 300, 129.442, -66.645, -108.273, -121.395, 8535545)
	spawnMobile("dantooine", "voritor_dasher", 300, 133.753, -66.845, -123.535, 158.367, 8535545)
	spawnMobile("dantooine", "voritor_lizard", 300, 127.040, -66.264, -124.947, 68.913, 8535545)
	spawnMobile("dantooine", "slinking_voritor_hunter", 300, 123.047, -66.279, -127.434, 73.805, 8535545)
	spawnMobile("dantooine", "voritor_lizard", 300, 128.005, -66.613, -129.858, 123.800, 8535545)
	spawnMobile("dantooine", "horned_voritor_lizard", 300, 145.676, -66.095, -129.911, 69.327, 8535545)
	spawnMobile("dantooine", "grassland_voritor_tracker", 300, 145.383, -67.245, -123.293, 63.859, 8535545)
	spawnMobile("dantooine", "horned_voritor_lizard", 300, 153.210, -66.317, -125.843, -104.211, 8535545)
	spawnMobile("dantooine", "slinking_voritor_hunter", 300, 152.361, -66.730, -119.473, 3.631, 8535545)
	spawnMobile("dantooine", "voritor_dasher", 300, 151.572, -66.763, -118.364, 44.413, 8535545)
	spawnMobile("dantooine", "voritor_lizard", 300, 142.453, -66.825, -89.447, 81.216, 8535545)
	spawnMobile("dantooine", "horned_voritor_lizard", 300, 135.516, -67.087, -90.002, -108.724, 8535545)
	spawnMobile("dantooine", "slinking_voritor_hunter", 300, 132.807, -66.278, -98.276, -144.906, 8535545)
	spawnMobile("dantooine", "grassland_voritor_tracker", 300, 134.646, -66.596, -99.549, 79.716, 8535545)
